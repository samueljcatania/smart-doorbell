...
template <>
class GIOMM_API Value<Gio::SocketType> : public Glib::Value_Enum<Gio::SocketType>
{
public:
...
template <>
class GIOMM_API Value<Gio::SocketProtocol> : public Glib::Value_Enum<Gio::SocketProtocol>
{
public:
  static GType value_type() G_GNUC_CONST;
};
...
template <>
class GIOMM_API Value<Gio::SocketMsgFlags> : public Glib::Value_Flags<Gio::SocketMsgFlags>
{
public:
  static GType value_type() G_GNUC_CONST;
};
