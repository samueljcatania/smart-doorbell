...
template <>
class GIOMM_API Value<Gio::ConverterResult> : public Glib::Value_Enum<Gio::ConverterResult>
{
public:
...
template <>
class GIOMM_API Value<Gio::ConverterFlags> : public Glib::Value_Flags<Gio::ConverterFlags>
{
public:
  static GType value_type() G_GNUC_CONST;
};
