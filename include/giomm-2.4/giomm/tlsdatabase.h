...
template <>
class GIOMM_API Value<Gio::TlsDatabaseVerifyFlags> : public Glib::Value_Flags<Gio::TlsDatabaseVerifyFlags>
{
public:
...
template <>
class GIOMM_API Value<Gio::TlsDatabaseLookupFlags> : public Glib::Value_Flags<Gio::TlsDatabaseLookupFlags>
{
public:
  static GType value_type() G_GNUC_CONST;
};
...
public:
   ...
   * certificate, TLS_CERTIFICATE_BAD_IDENTITY will be set in the
